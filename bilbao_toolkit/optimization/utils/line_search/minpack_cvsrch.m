function [x,f,grad,g,stp,info,nfev] = minpack_cvsrch(fcn,x,f,g,s,stp,...
                                        ftol,gtol,xtol, ...
...
%
      dginit = g'*s;
      if (dginit >= 0.0) 
         error('s is not a descent direction');
      end
%
...
%
            [stx,fxm,dgxm,sty,fym,dgym,stp,fm,dgm,brackt,infoc] ...
             = minpack_cstep(stx,fxm,dgxm,sty,fym,dgym,stp,fm,dgm, ...
                     brackt,stmin,stmax);
%
...
%
            [stx,fx,dgx,sty,fy,dgy,stp,f,dg,brackt,infoc] ...
             = minpack_cstep(stx,fx,dgx,sty,fy,dgy,stp,f,dg, ...
                     brackt,stmin,stmax);
         end
%
